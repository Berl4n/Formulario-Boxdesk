          ...
          {personType === "pf" ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="ligacao" id="pf-ligacao" />
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="imediato" id="pf-imediato" />
                    <Label htmlFor="pf-imediato" className="cursor-pointer text-foreground">
                      Imediato
                    </Label>
                  </div>
                </RadioGroup>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Label className="text-foreground">Forma de Contato</Label>
                <RadioGroup
                  value={pjData.formaContato}
                  onValueChange={(value) => setPjData({ ...pjData, formaContato: value })}
                  className="flex gap-4"
                >
                  <div className="flex items-center space-x-2">
              ...
              <div className="space-y-3">
                <Label className="text-foreground">Melhor Horário</Label>
                <RadioGroup
                  value={pjData.horario}
                  onValueChange={(value) => setPjData({ ...pjData, horario: value })}
                  className="flex flex-wrap gap-4"
                >
                  <div className="flex items-center space-x-2">
